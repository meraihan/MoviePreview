...
public class RatingRepository {
    ...
    public Rating addRating(Rating rating) {
        ...
        parameters.put("created_at", rating.getCreatedAt());
    ...
    public List<Rating> findAll() {
        String query = "SELECT * FROM ratings ORDER BY created_at DESC";
        try {
            return jdbcTemplate.query(query, new RowMapper<Rating>() {
                ...
                public Rating mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    rating.setCreatedAt(Helper.timeStampToLocalDateTime(rs.getTimestamp("created_at")));
                    return rating;
                }
            });

...
public class RatingRepository {
    ...
    private static final Logger log = Logger.getLogger(String.valueOf(RatingRepository.class));
        ...
        try {
            return jdbcTemplate.query(query, new RowMapper<Rating>() {
                ...
                public Rating mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    rating.setIsFavourite(rs.getInt("is_favourite"));
                    return rating;
                }
            });
        } catch (DataAccessException e) {
            log.info("rating query execution failed:" + e.getMessage());
    ...
    public List<Rating> findByUserId(int userId) {
        ...
        try{
            ...
            log.info("rating not found, error: "+ dae.getLocalizedMessage());
            return new ArrayList<>();
        }
    }
}

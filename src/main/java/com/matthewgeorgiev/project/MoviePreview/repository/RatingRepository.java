...
public class RatingRepository {
    ...
    public Rating addRating(Rating rating) {
        ...
        parameters.put("is_favourite", rating.getFavourite());
        ...
        try {
            return jdbcTemplate.query(query, new RowMapper<Rating>() {
                ...
                public Rating mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    rating.setFavourite(rs.getBoolean("is_favourite"));
                    return rating;
                }
            });
    ...
    public boolean updateRating(Rating rating) {
        ...
        try {
            return jdbcTemplate.update(query, new Object[] {rating.getRating(), rating.getFavourite(), rating.getId()}) == 1;
        } catch (DataAccessException dae) {
            log.info(dae.getLocalizedMessage());
        }
        return false;
